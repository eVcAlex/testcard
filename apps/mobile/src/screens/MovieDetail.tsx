  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.poster}>
        {movie.poster_url !== null && movie.poster_url !== "" ? <Image source={{ uri: movie.poster_url }} style={styles.posterImage} resizeMode="cover" resizeMethod="resize" fadeDuration={0} /> : null}
      </View>
