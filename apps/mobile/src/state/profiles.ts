...
import { listProfiles, MAIN_PROFILE, saveProfile, type Profile } from "@testcard/core/src/db/profiles.js";
 ...
 * and on each TV their own Home pins and caption and audio settings (see core's `db/profileSwap.ts`). Which profile
 * is watching is this TV's own.
 */
export { MAIN_PROFILE, type Profile };
...
/** The account's profiles, taking in (once) any made on this TV before profiles synced. */
